...
public class DefragmentTest {
    ...
    @Test
    public void wannaBeDog() {
        String[] input = {null, null, null, "now", null, "I", null, null, "wanna", "be", "your", "dog", null};
        String[] result = Defragment.compress(input);
        String[] expected = {"now", "I", "wanna", "be", "your", "dog", null, null, null, null, null, null, null};
        Assert.assertArrayEquals(expected, result);
    }
}